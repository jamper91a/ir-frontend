...
const routes: Routes = [
  ...
  { path: 'suppliers', loadChildren: './admin/suppliers/suppliers.module#SuppliersPageModule' },
  { path: 'supplier-create', loadChildren: './admin/suppliers/supplier-create/supplier-create.module#SupplierCreatePageModule' }
];
