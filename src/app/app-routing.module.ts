...
const routes: Routes = [
  ...
  { path: 'admin/reports/inventory/clientsReturn', loadChildren: './admin/reports/inventory/clientsreturn/clientsreturn.module#ClientsreturnPageModule' },
  { path: 'admin/reports/inventory/suppliersReturn', loadChildren: './admin/reports/inventory/suppliersreturn/suppliersreturn.module#SuppliersreturnPageModule' },
  { path: 'admin/reports/inventory/rotationProjected', loadChildren: './admin/reports/inventory/rotationprojected/rotationprojected.module#RotationprojectedPageModule' },
